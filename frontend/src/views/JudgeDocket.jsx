...
const JudgeDocket = () => {
    ...
    const sortedAndFilteredHearings = React.useMemo(() => {
        return allHearings
    ...
    }, [allHearings, viewMode, searchTerm, orderBy, order]);
                        ...
                        {sortedAndFilteredHearings
                            ...
                            .map((hearing) => (
                                <TableRow key={hearing.id} hover>
                                    ...
                                    {/* ✅ POPRAWKA TUTAJ: Usunięto 'noWrap' z TableCell */}
                                    <TableCell sx={{ maxWidth: 200 }}>
                                        {/* Przeniesiono 'noWrap' do Typography, gdzie jest poprawne */}
